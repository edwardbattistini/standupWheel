            ...
            let theWheel = new Winwheel({
                ...
                [                               // font size and test colour overridden on backrupt segments.
                   {'fillStyle' : '#ee1c24', 'text' : 'Edward'},
                   {'fillStyle' : '#3cb878', 'text' : 'Hannah'},
                   {'fillStyle' : '#f6989d', 'text' : 'Manuel'},
                   {'fillStyle' : '#00aef0', 'text' : 'Allan'},
                   {'fillStyle' : '#f26522', 'text' : 'Andy'},
                   {'fillStyle' : '#000000', 'text' : 'SUPRISE', 'textFontSize' : 16, 'textFillStyle' : '#ffffff'},
                   {'fillStyle' : '#e70697', 'text' : 'Daniel'},
                   {'fillStyle' : '#fff200', 'text' : 'Jason'},
                   {'fillStyle' : '#f6989d', 'text' : 'Leila'},
                   {'fillStyle' : '#ee1c24', 'text' : 'Marc'},
                   {'fillStyle' : '#3cb878', 'text' : 'Michal'},
                   {'fillStyle' : '#f26522', 'text' : 'Paula'},
                   {'fillStyle' : '#a186be', 'text' : 'Nerios'},
                   {'fillStyle' : '#fff200', 'text' : 'Pawel'},
                   {'fillStyle' : '#00aef0', 'text' : 'Sebastien'},
            ...
            function alertPrize(indicatedSegment)
            {
                ...
                if (indicatedSegment.text == 'LOOSE TURN') {
                    alert('Sorry but you loose a turn. Someone else gets to spin!');
                } else if (indicatedSegment.text == 'SURPRISE') {
                    alert('You are presenting all week! ');
                } else {
